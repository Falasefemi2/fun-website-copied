...
import CustomStyledHeader from "../common/custom-styled-header";
...
function LovedByBuildersSection() {
  ...
  return (
    <section className="relative bg-[#232529] px-4 md:px-23.5 py-29">
      <div>
        <CustomStyledHeader
        ...
        <MainButton
          ...
          size="small"
          className="border border-[#31373D] text-[#EDEEF0] rounded-[12px] bg-transparent mt-8"
        />
      </div>
