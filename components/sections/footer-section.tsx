...
function FooterSection() {
  ...
  return (
    <section className="bg-[#232529] px-4 md:px-23.5 py-22.5">
      <div>
        <img src="/images/footer_logo.svg" alt="footer logo" />
      </div>

      <div className="mt-8 pb-12.5 flex justify-between w-full gap-8 flex-col md:flex-row flex-wrap">
        <div>
          <p className="text-[#9098A0] mb-3">Product</p>
        ...
        <div>
          <p className="text-[#9098A0] mb-3">Company</p>
          <div className="flex flex-col gap-3">
        ...
        <div>
          <p className="text-[#9098A0] mb-3">Attio for</p>
          <div className="flex flex-col gap-3">
