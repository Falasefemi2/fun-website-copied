...
function ReadyToBuildSection() {
  return (
    <section className="flex flex-col md:flex-row justify-between gap-16 items-center bg-[#266DF0]!  px-4 md:px-23.5">
      <div>
        <p className="text-[40px] leading-tight md:leading-normal text-[#A0BFF8]">
